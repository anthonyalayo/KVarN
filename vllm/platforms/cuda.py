...
class CudaPlatformBase(Platform):
    ...
    def support_deep_gemm(cls) -> bool:
        ...
        # sm_120 (consumer Blackwell, e.g. RTX 5090) included per upstream v0.27.1:
        # the bundled DeepGEMM now supports it. KVarN previously excluded sm_120
        # because DeepGEMM 2.5.0 asserted "Unsupported architecture" in its
        # SF-layout/HyperConnection kernels (verified on V4-Flash, June 2026).
        # If the bundled DeepGEMM regresses on sm_120, drop the family(120) term.
        return (
